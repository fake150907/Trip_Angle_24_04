...
ALTER TABLE `travelSchedule` ADD CONSTRAINT `PK_TRAVELSCHEDULE` PRIMARY KEY (
	`id`
);
...
ALTER TABLE `genFile` ADD CONSTRAINT `PK_GENFILE` PRIMARY KEY (
	`id`
);

ALTER TABLE `regionInfoTips` ADD CONSTRAINT `PK_REGIONINFOTIPS` PRIMARY KEY (
	`id`
);

ALTER TABLE `anniversaryDates` ADD CONSTRAINT `PK_ANNIVERSARYDATES` PRIMARY KEY (
	`id`
);
...
ALTER TABLE `shoppingList` ADD CONSTRAINT `PK_SHOPPINGLIST` PRIMARY KEY (
	`id`
);
...
ALTER TABLE `recommendRegion` ADD CONSTRAINT `PK_RECOMMENDREGION` PRIMARY KEY (
	`id`
);

ALTER TABLE `tabList` ADD CONSTRAINT `PK_TABLIST` PRIMARY KEY (
	`id`
);

ALTER TABLE `recommendSpot` ADD CONSTRAINT `PK_RECOMMENDSPOT` PRIMARY KEY (
	`id`
);

ALTER TABLE `regionSymbolicWord` ADD CONSTRAINT `PK_REGIONSYMBOLICWORD` PRIMARY KEY (
	`id`
);
...
ALTER TABLE `reactionPoint` ADD CONSTRAINT `PK_REACTIONPOINT` PRIMARY KEY (
	`id`
);

ALTER TABLE `spotifyMember` ADD CONSTRAINT `PK_SPOTIFYMEMBER` PRIMARY KEY (
	`id`
);
...
ALTER TABLE `recommendSpotReview` ADD CONSTRAINT `PK_RECOMMENDSPOTREVIEW` PRIMARY KEY (
	`id`
);
